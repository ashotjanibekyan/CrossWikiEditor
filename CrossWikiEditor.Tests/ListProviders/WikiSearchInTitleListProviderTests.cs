...
public class WikiSearchInTitleListProviderTests : ListProvidersBaseTest
{
    private WikiSearchInTitleListProvider _sut;
    ...
    public void SetUp()
    {
        ...
        _sut = new WikiSearchInTitleListProvider(_dialogService, _pageService, _userPreferencesService)
        {
    ...
    {
        // arrange
        _pageService.WikiSearch(_userPrefs.UrlApi(), $"intitle:{_sut.Param}", Arg.Is<int[]>(x => x[0] == 0), 73)
