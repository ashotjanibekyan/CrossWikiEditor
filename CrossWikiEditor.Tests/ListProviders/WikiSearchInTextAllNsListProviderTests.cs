...
public class WikiSearchInTextAllNsListProviderTests : ListProvidersBaseTest
{
    private WikiSearchInTextAllNsListProvider _sut;
    ...
    {
        // arrange
        _pageService.WikiSearch(_userPrefs.UrlApi(), _sut.Param, null, 73)
