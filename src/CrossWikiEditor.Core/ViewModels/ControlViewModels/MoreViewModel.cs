...
public sealed partial class MoreViewModel : ViewModelBase
{
    ...
    public MoreViewModel(ISettingsService settingsService, IMessengerWrapper messenger)
    {
    ...
    [ObservableProperty]
    public partial FileTaskType FileType { get; set; }
