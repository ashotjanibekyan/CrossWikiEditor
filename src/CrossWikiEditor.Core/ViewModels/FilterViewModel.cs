...
public partial class FilterViewModel : ViewModelBase
{
    ...
    [ObservableProperty]
    public partial ObservableCollection<SetOperations> SetOperations { get; set; }
    ...
    [ObservableProperty]
    public partial string RemoveTitlesContaining { get; set; }

    [ObservableProperty]
    public partial string KeepTitlesContaining { get; set; }

    [ObservableProperty]
    public partial SetOperations SelectedSetOperations { get; set; }
