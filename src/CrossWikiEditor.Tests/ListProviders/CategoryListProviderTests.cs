...
public sealed class CategoryListProviderTests : ListProvidersBaseTest<CategoryListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new CategoryListProvider(_categoryService, _dialogService, _settingsService);
    ...
    {
        // arrange
        _categoryService.GetPagesOfCategory(_settingsService.CurrentApiUrl, _sut.Param, 73).Returns(_expectedPages);
    ...
    {
        // arrange
        _categoryService.GetPagesOfCategory(_settingsService.CurrentApiUrl, _sut.Param, 73).Returns(new Exception("failed to get pages"));
