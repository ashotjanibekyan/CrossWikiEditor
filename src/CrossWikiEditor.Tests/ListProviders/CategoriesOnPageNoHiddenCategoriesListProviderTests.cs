...
public sealed class CategoriesOnPageNoHiddenCategoriesListProviderTests : ListProvidersBaseTest<CategoriesOnPageNoHiddenCategoriesListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new CategoriesOnPageNoHiddenCategoriesListProvider(_categoryService, _dialogService, _settingsService) { Param = "page" };
    ...
    {
        // arrange
        _categoryService.GetCategoriesOf(_settingsService.CurrentApiUrl, _sut.Param, 73, false).Returns(_expectedPages);
    ...
    {
        // arrange
        _categoryService.GetCategoriesOf(_settingsService.CurrentApiUrl, _sut.Param, 73, false).Returns(new Exception("failed to get pages"));
