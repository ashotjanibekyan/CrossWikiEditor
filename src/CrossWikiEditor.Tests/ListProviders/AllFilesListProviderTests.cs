...
public sealed class AllFilesListProviderTests : ListProvidersBaseTest<AllFilesListProvider>
{
    ...
    {
        // arrange
        _pageService.GetAllFiles(_userSettings.GetApiUrl(), _sut.Param, 73)
    ...
    {
        // arrange
        _pageService.GetAllFiles(_userSettings.GetApiUrl(), _sut.Param, 73).Returns(Result<List<WikiPageModel>>.Failure("failed to get pages"));
