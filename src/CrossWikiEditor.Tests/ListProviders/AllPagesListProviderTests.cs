...
public sealed class AllPagesListProviderTests : ListProvidersBaseTest<AllPagesListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new AllPagesListProvider(_dialogService, _pageService, _settingsService, _viewModelFactory) { Param = "start from here" };
    ...
    public async Task MakeList_ShouldReturnPageServiceResults()
    {
        // arrange
        _pageService
            .GetAllPages(_userSettings.GetApiUrl(), _sut.Param, 7, PropertyFilterOption.Disable, PropertyFilterOption.Disable, 73)
