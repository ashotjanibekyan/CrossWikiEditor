...
public sealed class WhatTranscludesHereAllNsListProviderTests : ListProvidersBaseTest<WhatTranscludesHereAllNsListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new WhatTranscludesHereAllNsListProvider(_dialogService, _pageService, _settingsService) { Param = "start from here" };
    ...
    {
        // arrange
        _pageService.GetTransclusionsOf(_userSettings.GetApiUrl(), _sut.Param, null, 73).Returns(_expectedPages);
    ...
    {
        // arrange
        _pageService.GetTransclusionsOf(_userSettings.GetApiUrl(), _sut.Param, null, 73).Returns(new Exception("failed to get pages"));
