...
public sealed class WhatTranscludesHereListProviderTests : ListProvidersBaseTest<WhatTranscludesHereListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new WhatTranscludesHereListProvider(_dialogService, _pageService, _settingsService) { Param = "start from here" };
    ...
    {
        // arrange
        _pageService.GetTransclusionsOf(_userSettings.GetApiUrl(), _sut.Param, Arg.Is<int[]>(x => x[0] == 0), 73).Returns(_expectedPages);
    ...
    public async Task MakeList_ShouldReturnUnsuccessfulResult_WhenPageServiceReturnsUnsuccessfulResult()
    {
        // arrange
        _pageService
            .GetTransclusionsOf(_userSettings.GetApiUrl(), _sut.Param, Arg.Is<int[]>(x => x[0] == 0), 73)
