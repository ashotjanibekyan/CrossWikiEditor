...
public sealed class AllUsersListProviderTests : ListProvidersBaseTest<AllUsersListProvider>
{
    ...
    {
        // arrange
        _userService.GetAllUsers(_settingsService.CurrentApiUrl, _sut.Param, 73).Returns(_expectedPages);
    ...
    {
        // arrange
        _userService.GetAllUsers(_settingsService.CurrentApiUrl, _sut.Param, 73).Returns(new Exception("failed to get pages"));
