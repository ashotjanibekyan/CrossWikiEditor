...
public sealed class LinksOnPageListProviderTests : ListProvidersBaseTest<LinksOnPageListProvider>
{
    [SetUp]
    public void SetUp()
    {
        ...
        _sut = new LinksOnPageListProvider(_dialogService, _pageService, _settingsService) { Param = "start from here" };
    ...
    {
        _sut.Title.Should().Be("Links on page");
