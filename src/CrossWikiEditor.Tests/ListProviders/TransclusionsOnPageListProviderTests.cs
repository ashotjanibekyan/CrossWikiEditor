...
public sealed class TransclusionsOnPageListProviderTests : ListProvidersBaseTest<TransclusionsOnPageListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new TransclusionsOnPageListProvider(_dialogService, _pageService, _userPreferencesService)
        {
    ...
    {
        // arrange
        _pageService.GetTransclusionsOn(_userSettings.GetApiUrl(), _sut.Param, 73)
