...
public sealed class AllRedirectsListProviderTests : ListProvidersBaseTest<AllRedirectsListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new AllRedirectsListProvider(_dialogService, _pageService, _settingsService, _viewModelFactory) { Param = "start from here" };
    ...
    public async Task MakeList_ShouldReturnPageServiceResults()
    {
        // arrange
        _pageService
            .GetAllPages(_userSettings.GetApiUrl(), _sut.Param, 7, PropertyFilterOption.WithProperty, PropertyFilterOption.Disable, 73)
