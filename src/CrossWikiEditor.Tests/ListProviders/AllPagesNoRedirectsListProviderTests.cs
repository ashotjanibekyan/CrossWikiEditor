...
public sealed class AllPagesNoRedirectsListProviderTests : ListProvidersBaseTest<AllPagesNoRedirectsListProvider>
{
    ...
    public void SetUp()
    {
        ...
        _sut = new AllPagesNoRedirectsListProvider(_dialogService, _pageService, _settingsService, _viewModelFactory) { Param = "start from here" };
    ...
    public async Task MakeList_ShouldReturnPageServiceResults()
    {
        // arrange
        _pageService
            .GetAllPages(_userSettings.GetApiUrl(), _sut.Param, 7, PropertyFilterOption.WithoutProperty, PropertyFilterOption.Disable, 73)
