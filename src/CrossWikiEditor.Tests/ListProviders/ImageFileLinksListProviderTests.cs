...
public sealed class ImageFileLinksListProviderTests : ListProvidersBaseTest<ImageFileLinksListProvider>
{
    ...
    {
        // arrange
        _pageService.GetPagesByFileUsage(_settingsService.CurrentApiUrl, _sut.Param, 73).Returns(_expectedPages);
    ...
    {
        // arrange
        _pageService.GetPagesByFileUsage(_settingsService.CurrentApiUrl, _sut.Param, 73).Returns(new Exception("failed to get pages"));
