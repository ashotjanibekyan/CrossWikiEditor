...
public sealed class WikiSearchInTextAllNsListProviderTests : ListProvidersBaseTest<WikiSearchInTextAllNsListProvider>
{
    [SetUp]
    public void SetUp()
    {
        ...
        _sut = new WikiSearchInTextAllNsListProvider(_dialogService, _pageService, _userPreferencesService)
        {
    ...
    {
        // arrange
        _pageService.WikiSearch(_userSettings.GetApiUrl(), _sut.Param, null, 73)
    ...
    {
        _sut.Title.Should().Be("Wiki search (text) (all NS)");
