...
public sealed class FileDialogService : IFileDialogService
{
    ...
    public async Task<string[]?> OpenFilePickerAsync(string title, bool allowMultiple, List<string>? patterns = null)
    {
    ...
    public async Task<(Func<Task<Stream>>? openReadStream, Func<Task<Stream>>? openWriteStream)> SaveFilePickerAsync(
        string title,
